...
@Component({
  selector: 'ttti-mau-phieu-dich-vu',
  templateUrl: './mau-phieu-dich-vu.component.html',
  styleUrls: ['./mau-phieu-dich-vu.component.scss'],
})
export class MauPhieuDichVuComponent implements OnInit {
  id: number;
  user: any;
  lichKham: any;
  phieuDichVu: any;
