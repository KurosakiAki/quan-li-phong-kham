...
import { TinhTrangLoThuocComponent } from './tinh-trang-lo-thuoc.component';
...
const routes: Routes = [
  {
    path: '',
    component: TinhTrangLoThuocComponent,
  },
];
...
@NgModule({
  ...
  exports: [],
  declarations: [
    TinhTrangLoThuocComponent
  ],
  providers: [],
})
export class TinhTrangLoThuocModule { }
